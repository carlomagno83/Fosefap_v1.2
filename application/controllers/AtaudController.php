...
require_once 'forms/Ataud.php';

class AtaudController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Ataudes";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_Ataud();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Ataudes');
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
				...
				$idmodeloAtaudes = $form->getValue('idmodeloAtaudes'); 				
				$idtamanoAtaudes = $form->getValue('idtamanoAtaudes'); 
                ...
                $ataud = new Application_Model_DbTable_Ataud();
                //llamo a la funcion agregar, con los datos que recibi del form
                			
				$ataud->agregar($idmodeloAtaudes,$idtamanoAtaudes,$idcolor,$observacion);
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_Ataud();
    ...
    public function updateAction()
    {
        // action body
		//titulo para la pagina
        $this->view->title = "Modificar Ataudes";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_Ataud();
        //cambio el texto del boton submit
        $form->submit->setLabel('Grabar Ataudes');
        //lo asigno oa la accion (la pag web que se mostrara)
        $this->view->form = $form;
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
				...
				$ataud->cambiar($idataud,$idmodeloAtaudes,$idtamanoAtaudes,$idcolor,$observacion);
                //indico que despues de haber agregado el album,
                //me redirija a la accion index de AlbumController, es decir,
                //a la pagina que me muestra el listado de albumes
                $this->_helper->redirector('index');
