...
require_once 'forms/Cementerio.php';

class CementerioController extends Zend_Controller_Action
{
    ...
    {
        // action body
		$table = new Application_Model_DbTable_Cementerio(); 
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Cementerios";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_Cementerio();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Cementerios');
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                ...
                $cementerio = new Application_Model_DbTable_Cementerio();                    
				$cementerio->agregar($RUC,$nombre,$direccion,$iddepartamento,$idprovincias,$iddistrito,$telefono_fijo,$telefono_celular,$mail,$costo,$observacion);
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_Cementerio();
    ...
    public function updateAction()
    {
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                //aca ya estamos seguros de que los datos son validos
                //ahora los extraemos como se ve abajo
				$idcementerio = $form->getValue('idcementerio'); 								
				$RUC = $form->getValue('RUC'); 				
				$nombre = $form->getValue('nombre'); 
				$direccion = $form->getValue('direccion');
				$iddepartamento = $form->getValue('iddepartamento');
				...
				$cementerio->cambiar($idcementerio,$RUC,$nombre,$direccion,$iddepartamento,$idprovincias,$iddistrito,$telefono_fijo,$telefono_celular,$mail,$costo,$observacion);
