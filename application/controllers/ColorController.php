...
class ColorController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Colores";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_Color();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Colores');
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                ...
                $color = new Application_Model_DbTable_Color();
                //llamo a la funcion agregar, con los datos que recibi del form
                				
				$color->agregar($nombre);
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_Color();
