...
require_once 'forms/Combustible.php';

class CombustibleController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Combustible";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_Combustible();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Combustible');
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                ...
                $combustible = new Application_Model_DbTable_Combustible();
                //llamo a la funcion agregar, con los datos que recibi del form
                				
				$combustible->agregar($nombre);
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_Combustible();
    ...
    public function updateAction()
    {
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
				...
				$combustible->cambiar($idcombustible,$nombre);
                //indico que despues de haber agregado el album,
                //me redirija a la accion index de AlbumController, es decir,
                //a la pagina que me muestra el listado de albumes
                $this->_helper->redirector('index');
