...
require_once 'forms/Crematorio.php';

        
class CrematorioController extends Zend_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        // action body
		$table = new Application_Model_DbTable_Crematorio(); 
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Crematorio";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_Crematorio();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Crematorio');
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                ...
                $crematorio = new Application_Model_DbTable_Crematorio();                    
				$crematorio->agregar($RUC,$nombre,$direccion,$iddistrito,$telefono_fijo,$telefono_celular,$mail,$costo,$observacion);
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_Crematorio();
    ...
    public function updateAction()
    {
         // action body
		//titulo para la pagina
        $this->view->title = "Agregar Crematorios";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_Crematorio();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Crematorios');
        //lo asigno oa la accion (la pag web que se mostrara)
        $this->view->form = $form;
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                //aca ya estamos seguros de que los datos son validos
                //ahora los extraemos como se ve abajo
				$idcrematorio = $form->getValue('idcrematorio'); 								
				$RUC = $form->getValue('RUC'); 				
				$nombre = $form->getValue('nombre'); 
				$direccion = $form->getValue('direccion');
				$iddistrito = $form->getValue('iddistrito');
				...
				$crematorio->cambiar($idcrematorio,$RUC,$nombre,$direccion,$iddistrito,$telefono_fijo,$telefono_celular,$mail,$costo,$observacion);
