...
require_once 'forms/ModeloAtaud.php';

class ModeloAtaudController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Modelos de Ataud";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_ModeloAtaud();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Modelos de Ataud');
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                ...
                $modeloataud = new Application_Model_DbTable_ModeloAtaud();
                //llamo a la funcion agregar, con los datos que recibi del form
                				
				$modeloataud->agregar($nombre,$observacion);
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_ModeloAtaud();
    ...
    public function updateAction()
    {
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
				...
				$modeloataud->cambiar($idmodeloAtaudes,$nombre,$observacion);
                //indico que despues de haber agregado el album,
                //me redirija a la accion index de AlbumController, es decir,
                //a la pagina que me muestra el listado de albumes
                $this->_helper->redirector('index');
