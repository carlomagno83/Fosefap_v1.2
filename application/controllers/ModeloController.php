...
class ModeloController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Modelos";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_Modelo();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Modelos');
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_Modelo();
    ...
    public function updateAction()
    {
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
				...
				$modelo->cambiar($idmodelo,$nombre);
                //indico que despues de haber agregado el album,
                //me redirija a la accion index de AlbumController, es decir,
                //a la pagina que me muestra el listado de albumes
                $this->_helper->redirector('index');
