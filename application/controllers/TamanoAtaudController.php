...
require_once 'forms/TamanoAtaud.php';

class TamanoAtaudController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Tamaños de los Ataudes";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_TamanoAtaud();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Tamaños de los Ataudes');
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                ...
                $tamanoataud = new Application_Model_DbTable_TamanoAtaud();
                //llamo a la funcion agregar, con los datos que recibi del form
                				
				$tamanoataud->agregar($nombre,$observacion);
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_TamanoAtaud();
    ...
    public function updateAction()
    {
        // action body
		//titulo para la pagina
        $this->view->title = "Agregar Tamaño de los Ataudes";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_TamanoAtaud();
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
				...
				$tamanoataud->cambiar($idtamanoAtaudes,$nombre,$observacion);
                //indico que despues de haber agregado el album,
                //me redirija a la accion index de AlbumController, es decir,
                //a la pagina que me muestra el listado de albumes
                $this->_helper->redirector('index');
