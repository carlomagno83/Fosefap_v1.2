...
require_once 'forms/TipoCandelabro.php';

class TipoCandelabroController extends Zend_Controller_Action
{
    ...
    public function addAction()
    {
        ...
        $this->view->title = "Agregar Tipo de Candelabro";
        //valor para <head><title>
        $this->view->headTitle($this->view->title);
        //creo el formulario
        $form = new Application_Form_TipoCandelabro();
        //cambio el texto del boton submit
        $form->submit->setLabel('Agregar Tipo de Candelabro');
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
                ...
                $tipocandelabro = new Application_Model_DbTable_TipoCandelabro();
                //llamo a la funcion agregar, con los datos que recibi del form
                				
				$tipocandelabro->agregar($nombre,$observacion);
    ...
    public function deleteAction()
    {
        ...
        $tabla = new Application_Model_DbTable_TipoCandelabro();
    ...
    public function updateAction()
    {
        ...
        if ($this->getRequest()->isPost())
        {
            ...
            if ($form->isValid($formData))
            {
				...
				$tipocandelabro->cambiar($idtipoCandelabros,$nombre,$observacion);
                //indico que despues de haber agregado el album,
                //me redirija a la accion index de AlbumController, es decir,
                //a la pagina que me muestra el listado de albumes
                $this->_helper->redirector('index');
